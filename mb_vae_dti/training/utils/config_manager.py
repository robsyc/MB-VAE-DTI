...
class ConfigManager:
    """
    Manages hierarchical configuration loading and generation of gridsearch and ensemble configurations.
    ...
    def _load_hierarchical_config(self, model_type: str, config_name: str) -> DictConfig:
        ...
        # Load and merge all configs, giving priority to more specific configs
